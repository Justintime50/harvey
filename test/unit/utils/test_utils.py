...
def test_kill(mock_logger, mock_store_deployment_details, mock_exit, mock_output, mock_webhook):
...
def test_kill_with_slack(mock_logger, mock_store_deployment_details, mock_slack, mock_exit, mock_output, mock_webhook):
    Utils.kill_deployment(mock_output, mock_webhook)
