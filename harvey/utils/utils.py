...
class Utils:
    ...
    def kill_deployment(message: str, webhook: Dict[str, Any], raise_error: Optional[bool] = False):
        ...
        store_deployment_details(webhook, Utils._strip_emojis_from_logs(error_message))
    ...
    def succeed_deployment(message: str, webhook: Dict[str, Any]):
        ...
        store_deployment_details(webhook, Utils._strip_emojis_from_logs(deployment_logs))
